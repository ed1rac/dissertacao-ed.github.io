...
Foi gerado, então, dois novos arquivos de políticas, também randomicamente, e, ainda, a partir do proposto em \citeonline{sarkis2017} e, cf. o exposto na \autoref{modelo_politica_utilizada}. Os arquivos gerados agora, possui, 139  e 281 políticas nomeadas.
...
Foi utilizada uma técnica que transforma um atributo categórico com $k$ valores em uma representação numérica com valores inteiros para cada $k$ valor. Há vantagens e desvantagens nessa abordagem. Elas estão discutidas em detalhes em \citeonline{sarkar_2017}.
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=.6\textwidth]{imagens/classe.png}}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[width=.7\textwidth]{imagens/mlp_classifier.png}}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[width=.6\textwidth]{imagens/validacao_notebook.png}}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=.6\textwidth]{imagens/forward.png}}
...
\begin{figure}
	...
	\fbox{\includegraphics[width=.6\textwidth]{imagens/convergencia.png}}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=.7\textwidth]{imagens/arquitetura-RNN-vertical.png}}
...
\begin{center}
	...
	\begin{tabular}{@{}lccccccccc@{}}
		\toprule
		\textbf{Atividades} & \textbf{\begin{tabular}[c]{@{}c@{}}1ª \\ qui\\ ago\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}2ª \\ qui\\ ago\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}1ª \\ qui\\ set\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}2ª \\ qui\\ set\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}1ª \\ qui\\ out\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}2ª \\ qui\\ out\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}1ª\\ qui\\ nov\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}2ª\\ qui\\ nov\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}1ª\\ qui\\ dez\end{tabular}} \\ \midrule
		...
		\begin{tabular}[c]{@{}l@{}}Comparação final com outros \\ classificadores (preferencialmente,\\ geométricos, como o KNN e o \\ SVM,avaliando suas acurácias \\ e eficiência (para os conflitos \\ indiretos)\end{tabular} &  &  &  & X & X & X &  &  &  \\
		\begin{tabular}[c]{@{}l@{}}Escrita, revisão e entrega de \\ resultados iniciais\end{tabular} &  &  &  &  & X & X & X & X &  \\
		Texto final com resultados &  &  &  &  &  &  & X & X & X \\ \bottomrule
	\end{tabular}
\end{table}
\end{center}
